...
class SkillService 
{
     ...
     * Übergeben wird die User-ID soswie ein Array von Skill-ID´s
     */
    ...
    //Lädt die Skills der Users aus der Datenbank, gibt ein Array von Objekten der Klasse Skill zurück
    public function getSkillsByUserId(int $userId) : array
    {
        /**Verknüpfung der Zwischentabelle user_skill 
         * mit skill beim SELECT holen wir uns nur die Infos aus der Skill-Tabelle heraus damit ich weiß welche Skills die Person hat
         * muss jedoch zuvor die Verknüpfung mit dem INNER JOIN geschenen
         * */
        $ps = $this->conn->prepare('
